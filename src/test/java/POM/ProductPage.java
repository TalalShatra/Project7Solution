...
public class ProductPage extends BasePOM {
    ...
    @FindBy(css = "[id=\"ui-id-2\"]>li:nth-of-type(3)")
    private WebElement menMenuBtn;
    ...
    @FindBy(xpath = "(//*[@class=\"swatch-attribute-options clearfix\"])[1]/div")
    private List<WebElement> sizeList;

    @FindBy(xpath = "(//*[@class=\"swatch-attribute-options clearfix\"])[2]/div")
    ...
    @FindBy(css = "[id=\"checkout-shipping-method-load\"] input")
    ...
    public void findAndSend(String strElement, String value) {
        ...
        switch (strElement) {
            ...
            case "checkOutCompany":
                myElement = checkOutCompany;
                break;
            case "checkOutStreet":
                myElement = checkOutStreet;
                break;
            case "checkOutCity":
                myElement = checkOutCity;
                break;
            case "checkOutPhone":
                myElement = checkOutPhone;
                break;
            case "checkOutZipcode":
                myElement = checkOutZipcode;
                break;
        }
    ...
    public void chooseElement(String strElement, String value) {
        switch (strElement) {
            case "checkOutCountry":
                myElement = checkOutCountry;
                break;
            case "checkOutState":
                myElement = checkOutState;
                break;
        }
    ...
    public void findAndClick(String strElement) {
        switch (strElement) {
            case "menMenuBtn":
                myElement = menMenuBtn;
                break;
            case "jacketsBtn":
                myElement = jacketsBtn;
                break;
            case "addToCart":
                myElement = addToCart;
                break;
            ...
            case "shoppingCart":
                ...
                break;
            case "placeOrderBtn":
                myElement = placeOrderBtn;
                break;
            case "checkoutAddress":
                myElement = checkoutAddress;
                break;
    ...
    public void chooseAndClick(String strElement) {
        switch (strElement) {
            case "productList":
                myListElement = productList;
                break;
            case "sizeList":
                myListElement = sizeList;
                break;
            case "colorList":
                myListElement = colorList;
                break;
            case "radioBtnList":
                myListElement = radioBtnList;
                break;
        }
        clickRandomlyFromAList(myListElement);
